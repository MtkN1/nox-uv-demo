...
APP_NAME="uv"
APP_VERSION="0.1.29"
ARTIFACT_DOWNLOAD_URL="${INSTALLER_DOWNLOAD_URL:-https://github.com/astral-sh/uv/releases/download/0.1.29}"
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"install_prefix":"AXO_INSTALL_PREFIX","provider":{"source":"cargo-dist","version":"0.13.0-prerelease.3"},"source":{"app_name":"uv","name":"uv","owner":"astral-sh","release_type":"github"},"version":"0.1.29"}
EORECEIPT
...
The installer for uv 0.1.29

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/astral-sh/uv/releases/download/0.1.29
...
download_binary_and_run_installer() {
    ...
    case "$_arch" in 
        ...
        "arm-unknown-linux-musleabihf")
            _artifact_name="uv-arm-unknown-linux-musleabihf.tar.gz"
            _zip_ext=".tar.gz"
            _bins="uv"
            _bins_js_array='"uv"'
            ;;
        ...
        "armv7-unknown-linux-musleabihf")
            _artifact_name="uv-armv7-unknown-linux-musleabihf.tar.gz"
            _zip_ext=".tar.gz"
            _bins="uv"
            _bins_js_array='"uv"'
            ;;
